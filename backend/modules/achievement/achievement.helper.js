...
const SESSION_MILESTONES = [
    { count: 1,   name: 'First Step',     description: 'Completed your first session', badge: 'common',    icon: '👣' },
    { count: 10,  name: 'On a Roll',       description: 'Completed 10 sessions',        badge: 'rare',      icon: '🎯' },
    { count: 50,  name: 'Session Veteran', description: 'Completed 50 sessions',        badge: 'epic',      icon: '⚔️' },
    { count: 100, name: 'Session Legend',  description: 'Completed 100 sessions',       badge: 'legendary', icon: '🏆' },
];

const FRIENDSHIP_MILESTONES = [
    { count: 1,  name: 'First Connection',  description: 'Made your first friend', badge: 'common',    icon: '🤝' },
    { count: 5,  name: 'Social Butterfly',  description: 'Made 5 friends',         badge: 'rare',      icon: '🦋' },
    { count: 25, name: 'Popular',           description: 'Made 25 friends',        badge: 'epic',      icon: '⭐' },
    { count: 50, name: 'Networking Legend', description: 'Made 50 friends',        badge: 'legendary', icon: '👑' },
];

const STREAK_MILESTONES = [
    { count: 3,   name: 'Hat Trick',   description: '3 day streak',   badge: 'common',    icon: '🎩' },
    { count: 7,   name: 'Week Warrior',description: '7 day streak',   badge: 'rare',      icon: '⚡' },
    { count: 30,  name: 'Consistent',  description: '30 day streak',  badge: 'epic',      icon: '🔥' },
    { count: 100, name: 'Unstoppable', description: '100 day streak', badge: 'legendary', icon: '💎' },
];
