      ...
      const timer = setTimeout(() => {
        ...
        setMessages((prev) => [
          ...prev,
          {
            ...
            role: "ai",
            content:
              "That's a great question! I'm here to help you study more effectively. In a real integration, this response would come from an AI backend via WebSocket or REST API.",
            time: getTime(),
          },
        ]);
      }, 1500);
                  ...
                  <div className="flex-1 flex flex-col sm:flex-row overflow-hidden w-full">
                    ...
                    <motion.div
                      ...
                      className={`flex flex-col overflow-hidden ${
                        uploadedFile && filePreview && showDocPreview
