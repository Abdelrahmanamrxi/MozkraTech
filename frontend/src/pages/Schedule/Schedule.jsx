...
const Schedule = () => {
     ...
     <Body>
      <section className="min-h-screen p-7 lg:p-14 pt-12 lg:pt-20 ">
          ...
          <div className="flex flex-row gap-3 mt-4 text-white relative">
            ...
            <AnimatePresence>
              {showFilterPopup && (
                ...
                >
                  <p className="text-sm font-semibold text-w mb-3">Filter by Subject</p>
        ...
        <div className="bg-[#3D3555]/60 p-8 w-full rounded-[24px] text-white font-Inter border-t border-[#9B7EDE]/20 mt-12">
          <p className="text-2xl font-semibold mb-8">Weekly Schedule</p>
          ...
          <div className="grid grid-cols-1 font-Inter md:grid-cols-2 lg:grid-cols-7 gap-4">
            {days.map((day, dayIndex) => (
              ...
              >
                <p className="text-center bg-[#52466B] rounded-[16px] px-3 py-2 text-sm font-semibold text-white mb-4">{day}</p>
  ...
  >
    <p className="text-[#B8A7E5] text-sm">No sessions scheduled</p>
        ...
        className="border-t flex flex-col lg:flex-row font-Inter text-white items-center gap-3 rounded-[24px] p-6 border-[#9B7EDE]/30 mt-8 mb-16">
            ...
            <div className="flex items-center lg:items-start flex-col gap-2">
                ...
                <p className="text-xs leading-relaxed text-center lg:text-start text-[#B8A7E5]">Schedule your most challenging subjects during your peak productivity hours. Most students perform best in the morning (8-11 AM) or late afternoon (3-5 PM). Try to align difficult topics with these time slots for optimal learning.</p>
            </div>
            </div>
      </section>
    </Body>
