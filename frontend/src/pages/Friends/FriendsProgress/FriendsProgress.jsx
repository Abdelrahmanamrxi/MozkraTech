...
const FriendsProgress = () => {
  return (
  <div className="font-Inter min-h-screen mt-4  flex items-start justify-center">
      <motion.div
  ...
  >
    {fullRankings.map((user) => (
      <motion.div
        key={user.rank}
        variants={itemVariants}
        className="flex items-center gap-3 sm:gap-4 px-4 sm:px-5 py-3 hover:bg-white/[0.03] border-b border-[#9B7EDE]/20 last:border-b-0 transition-colors duration-150 cursor-pointer"
      >
        {/* Rank */}
