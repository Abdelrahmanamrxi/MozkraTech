...
const fullRankings = [
  {
    ...
    level: 9,
    initials: "SJ",
    color: "bg-[linear-gradient(180deg,#9B7EDE_0%,#7C5FBD_100%)]",
    hours: "142h",
    goals: 22,
  },
  {
          ...
          >
            ...
            <div className="flex items-center gap-3">
              <div className="relative flex-shrink-0">
                ...
                <span className="absolute -top-1 -right-1 w-5 h-5 rounded-full text-[10px] font-bold flex items-center justify-center bg-[#3D3555] text-white border-2">
                  {user.rank}
                </span>
              </div>
              <div>
          ...
          {fullRankings.map((user) => (
            ...
            >
              ...
              <div className="text-right flex-shrink-0">
                ...
                <p className="text-purple-300/60 text-xs">
                  {user.goals} {t("leaderboard.goals")}
                </p>
              </div>
            </motion.div>
          ))}
