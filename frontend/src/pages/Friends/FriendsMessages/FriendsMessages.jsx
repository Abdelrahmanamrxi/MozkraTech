...
const friends = [
  {
    ...
    initials: "SJ",
    status: "online",
    lastMsg: "Hey! Ready for the algorithm test?",
    time: "2m ago",
    unread: 2,
    messages: [
      {
        id: 1,
        from: "them",
        text: "Cool! I struggled with that part. Want to review it together?",
        time: "05:43 PM",
      },
      {
        id: 2,
      ...
      },
      {
        id: 3,
        from: "them",
        text: "Perfect! Library study room?",
        time: "06:13 PM",
      },
      {
        id: 4,
        from: "them",
        text: "Hey! Ready for the algorithm test?",
        time: "06:21 PM",
      },
    ],
  },
  {
    ...
    initials: "AC",
    status: "online",
    lastMsg: "Check out this study guide I found",
    time: "15m ago",
    unread: 0,
    messages: [
      {
        id: 1,
        from: "them",
        text: "Check out this study guide I found",
        time: "09:15 AM",
      },
      {
        id: 2,
      ...
      },
      {
        id: 3,
        from: "them",
        text: "No problem! Good luck on the exam 🎯",
        time: "09:21 AM",
      },
    ],
  },
  {
    ...
    initials: "ED",
    status: "offline",
    lastMsg: "Can we study together tomorrow?",
    time: "1h ago",
    unread: 1,
    messages: [
      {
        id: 1,
        from: "me",
        text: "Hey Emma! How's the project going?",
        time: "11:00 AM",
      },
      {
        id: 2,
        from: "them",
        text: "Almost done! Just finishing the last section",
        time: "11:45 AM",
      },
      {
        id: 3,
        from: "them",
        text: "Can we study together tomorrow?",
        time: "12:10 PM",
      },
    ],
  },
    ...
    messages: [
      {
        id: 1,
        from: "them",
        text: "Could you send me your notes from today?",
        time: "08:00 AM",
      },
  ...
  },
  {
    ...
    initials: "OM",
    status: "online",
    lastMsg: "Great job on your presentation!",
    time: "5h ago",
    unread: 0,
    messages: [
      {
                  ...
                  <div className="p-4 border-b border-[#9B7EDE]/10">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <span className="text-xs text-purple-300/50">
                        {allFriends.filter((f) => f.unread > 0).length}{" "}
                        {t("messages.unread")}
                      </span>
                    </div>
                    {/* Search */}
                    ...
                    {filtered.map((friend) => (
                      ...
                      >
                        <div className="relative flex-shrink-0">
                          ...
                          <div
                            className={`absolute bottom-0 right-0 w-2.5 h-2.5 ${statusColor[friend.status]} rounded-full border-2 border-[#2A2440]`}
                          />
                        </div>
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center justify-between mb-0.5">
                            <span
                              className={`text-sm font-medium truncate ${activeId === friend.id ? "text-white" : "text-white/90"}`}
                            >
                              {friend.name}
                            </span>
                            <span className="text-[10px] text-purple-300/40 flex-shrink-0 ml-1">
                              {friend.time}
                            </span>
                          </div>
            ...
            <div className="px-4 py-3 border-b border-[#9B7EDE]/20 flex items-center justify-between flex-shrink-0">
              <div className="flex items-center gap-3">
                ...
                <div className="relative flex-shrink-0">
                  ...
                  <div
                    className={`absolute bottom-0 right-0 w-2.5 h-2.5 ${statusColor[activeFriend.status]} rounded-full border-2 border-[#2A2440]`}
                  />
                </div>
