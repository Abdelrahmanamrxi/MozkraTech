...
const tagColors = {
  ...
  "Exam Success": { bg: "rgba(16, 185, 129, 0.15)", color: "#6ee7b7" },
  Milestone: { bg: "rgba(234, 179, 8, 0.15)", color: "#fde68a" },
  "Skill Achievement": { bg: "rgba(59, 130, 246, 0.15)", color: "#93c5fd" },
};
    ...
    <Card variant="dark" className="p-6">
      ...
      <div className="flex flex-col gap-3">
        {mockProgressData.milestones.map((milestone, index) => {
          const tagStyle = tagColors[milestone.tag] || {
          ...
          return (
            ...
            >
              <GlassySection classname="flex flex-row items-center gap-4 w-full">
                {/* Icon */}
                <div
                  className="w-9 h-9 rounded-full flex items-center justify-center flex-shrink-0"
                  style={{ background: "rgba(144, 103, 198, 0.22)" }}
                >
                  <svg
                    width="20"
                    height="20"
                ...
                <div className="flex flex-col flex-1 min-w-0">
                  <p className="font-blinker font-semibold text-white text-sm truncate">
                    {milestone.title}
                  </p>
