...
import {Card} from "./sections/TodaysSummary/TopCard";
...
function Home() {
  ...
  <div className="flex flex-col lg:flex-row gap-8 mt-10 items-start">
    ...
    <div className="flex-1 flex flex-col gap-8">
      ...
      <div>Today's Schedule Here</div>

    </div>

    {/* Right column — Upcoming Schedule */}
    <div className="glassy-secondary-background rounded-3xl shrink-0 lg:w-1/4 w-full p-5">
      <p className="flex flex-row gap-5 items-center"><CalenderIcon />Upcoming Schedule</p>
